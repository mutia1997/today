...
# Display Top 5 Financial Losses table by Date with Blue Border
...
st.write(top_5_fl_tanggal, unsafe_allow_html=True)
...
# Display Top 5 Lost Products table with Blue Border
...
st.write(top_5_lost_products, unsafe_allow_html=True)
...
# Display Top 5 Financial Losses table by Products with Blue Border
...
st.write(top_5_fl_produk, unsafe_allow_html=True)
...
# Display Top 5 Financial Losses table by Machine with Blue Border
...
st.write(top_5_fl_mesin, unsafe_allow_html=True)
